...
void main() {
  group('Onboarding Widgets', () {
    ...
    testWidgets('ClubMultiSelectStep error message is localized', (
      tester,
    ) async {
      // Placeholder: implement provider mock to force error and check localization
      expect(true, isTrue);
    ...
    testWidgets('PersonalDataStep error message is localized', (tester) async {
      // Placeholder: implement provider mock to force error and check localization
      expect(true, isTrue);
    });
  });
  ...
  group('Auth Widgets', () {
    ...
    testWidgets('LoginScreenNeumorphic shows email and password fields', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
      ...
      await tester.pumpAndSettle();
      expect(find.textContaining('Correo', findRichText: true), findsOneWidget);
      expect(
        find.textContaining('Contraseña', findRichText: true),
        findsOneWidget,
      );
    });
  });
